...
ComboData = {
    menu = {
        ...
        { set = "rNH MS DH rAS",    name = "73611@" },
        { set = "VL DH rIN rDP",    name = "Non-Self" },
        { set = "rMS rVL DH",       name = "The Unfavorable One" },
        { set = "rDH IN",           name = "Zenith Clicker: Obfuscated" },
    },
    ...
    gameEX = {
        ...
        { set = "EX NH MS VL AS", name = "Crimson Witch" }, -- Lucy!!! :D
        { set = "EX NH MS VL DP", name = "The Fleeing Partners" },
        ...
        { set = "NH MS VL AS DP", name = "Bewitched Canvas" }, -- Lucy again!! :DDD
...
PieceData = { -- If you want to add more, keep these in mind: game.lua (174, 2485, 2770), tower.lua (1670, 1678), panel.lua
    ...
    { id = 'noHit',     text = { COLOR.lA, "P", }, popup = { COLOR.lA, "P - No-Hit" } },
    { id = 'ryoshu',    text = { COLOR.lF, "R", }, popup = { COLOR.lF, "R - Redaction" } },
    { id = 'graceless', text = { COLOR.lI, "G", }, popup = { COLOR.lI, "G - Graceless"} },
...
local function noHit() return math.max(GAME.floor, GAME.negFloor) >= 1 and GAME.life == 1 end
...
RevivePrompts = {
    ...
    { rank = { 1, 3 }, prompt = 'heal',                 target = 8,   short = "Heal 8 HP",               text = "Heal 8 HP",                                    cond = noHit },
    { rank = { 2, 4 }, prompt = 'heal',                 target = 20,  short = "Heal 20 HP",              text = "Heal 20 HP",                                   cond = noHit },
    ...
    { rank = { 2, 2 }, prompt = 'dmg_time',             target = 4,   short = "Take Dmg 4x",             text = "Take damage 4 times",                          cond = noHit },
    { rank = { 3, 3 }, prompt = 'dmg_time',             target = 8,   short = "Take Dmg 8x",             text = "Take damage 8 times",                          cond = noHit },
    { rank = { 2, 4 }, prompt = 'dmg_amount',           target = 10,  short = "Lose 10 HP",              text = "Take 10 damage total",                         cond = noHit },
    { rank = { 4, 6 }, prompt = 'dmg_amount',           target = 20,  short = "Lose 20 HP",              text = "Take 20 damage total",                         cond = noHit },
    { rank = { 3, 4 }, prompt = 'timedmg_time',         target = 2,   short = "Take Time Dmg 2x",        text = "Take time damage 2 times",                    cond = F6, noHit },
    { rank = { 5, 6 }, prompt = 'timedmg_time',         target = 4,   short = "Take Time Dmg 4x",        text = "Take time damage 4 times",                    cond = F6, noHit },
    { rank = { 4, 6 }, prompt = 'keep_health_safe',     target = 8,   short = "Safe HP 8s",              text = "Keep HP safe\nfor 8 seconds",                 cond = F6, noHit },
    { rank = { 4, 5 }, prompt = 'keep_health_danger',   target = 3,   short = "Critical HP 3s",          text = "Keep HP critical\nfor 3 seconds",             cond = F6, noHit },
...
BadgeData = {
    ...
    },
    {
        id = 'mastery_3',
        name = "Subjugation+",
        desc = "Reached F10 with all single ultra reversed mods",
    },
    {
        id = 'speedrun_3',
        name = "Omnipotence+",
        desc = "Finished a speedrun with all single ultra reversed mods",
    },
    {
        id = 'subluminal',
        name = "Sub-luminal",
