...
TEXTURE = {
    ...
    stat = {
        ...
        banner = assets 'stat/banners/default.png',
    ...
    achievement = {
        ...
        iconQuad = {
            ...
            sw_Inhumane = aq(15, 8),
            sw_Process = aq(15, 7),
            sw_ZCObfuscated = aq(2, 8),
            sw_muga = aq(16, 8),
            sw_checkpoint1 = aq(11, 8),
            sw_niflhel = aq(16, 7),
            sw_angelicide = aq(10, 8),
        },
        frame = {
    ...
    sw_about_bg = assets 'sw_about_bg.jpg',
}
...
SCN.add('panel', require 'module/scene/panel')
SCN.add('ending', require 'module/scene/ending')
SCN.add('code', require 'module/scene/code')
SCN.add('sw_about', require 'module/scene/sw_about')
...
function ReloadTexts()
    ...
    SWAboutText:setFont(FONT.get(70))
